...
/// </summary>
public class ResponseBodyLoggingMiddleware(RequestDelegate next, ILogger<ResponseBodyLoggingMiddleware> logger)
{
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        logger.LogDebug("Response Body: {sanitizedResponseBody}", sanitizedResponseBody);
        context.Response.Body.Seek(0, SeekOrigin.Begin);
